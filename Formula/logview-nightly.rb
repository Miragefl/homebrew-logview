...
class LogviewNightly < Formula
  ...
  version "0.9.0-nightly-20260519-101216"

  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/Miragefl/logview/releases/download/nightly/logview-darwin_amd64.tar.gz"
      sha256 "9facdadf6e4d49c3ca11965de315d7e24640f714146e5129e09e9bd0ef47c639"
    ...
    if Hardware::CPU.arm?
      ...
      sha256 "2807ab7c645f665678988e817936f906f3363cf13b484d29bf54bd73eeedd6c8"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      ...
      sha256 "5a5848e783b7511a7f6409f22bd9a39fe6dbf917170f2fbc3a728b10c0b2b8db"
      define_method(:install) do
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      sha256 "82de77f97f6ba82e952aac7a130ac6c56fe25c8653311df64117a8e6f9c33489"
      define_method(:install) do
