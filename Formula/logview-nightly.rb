...
class LogviewNightly < Formula
  ...
  version "0.10.0-nightly-20260520-062639"

  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/Miragefl/logview/releases/download/nightly/logview-darwin_amd64.tar.gz"
      sha256 "8cebf609069b48264f04ceac9297e7d865517eb97fe878bf9130a7fe0e85cd8d"
    ...
    if Hardware::CPU.arm?
      ...
      sha256 "eae43c43884d65752ab5ebdf6f8590b4e32272b3e06a067b728b9a58856f3c2d"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      ...
      sha256 "a37a8ff4c4f9bea5524396e0dda2b47fa880b87f520acd537883e3e90abc2fb9"
      define_method(:install) do
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      sha256 "9f12bd2cace912d35ae29a6f8c3585323ca2dfc9a35569fe5c97662c47931877"
      define_method(:install) do
