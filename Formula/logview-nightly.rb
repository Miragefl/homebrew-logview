...
class LogviewNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "36344187e79b4d7b3a554029eab31f6837540b86743361b7e60ee4b53421b6f8"
    ...
    if Hardware::CPU.arm?
      ...
      sha256 "8601cbb850a769855cf67b15a3e8a50b2ed76ba25763d00244ec861ead452400"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      ...
      sha256 "a5f16370f3a01d9ae670c0b24bee5ba70df61f2b8b6b8b541f84c0fe8bc010a4"
      define_method(:install) do
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      sha256 "169c0be6669c7aab90af12f24949cb0c25960b591edda43512402bba24ce113e"
      define_method(:install) do
